...
@available(macOS 10.15, *)
public func ShowSystemAlert(ImageName:String = "", AlertText:String = "", Timer:Double = 1.5, ImageColor:Color = Color("ImageColor"), FontColor:Color = Color("BNWColor")) -> NSWindow{
